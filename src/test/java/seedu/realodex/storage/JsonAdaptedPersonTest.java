...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_INCOME, VALID_EMAIL, VALID_ADDRESS,
                                      VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_INCOME, VALID_EMAIL,
                VALID_ADDRESS, VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_INCOME, VALID_EMAIL,
                VALID_ADDRESS, VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_INCOME, null,
                VALID_ADDRESS, VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_INCOME, VALID_EMAIL,
                null, VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidFamily_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_INCOME, VALID_EMAIL, VALID_ADDRESS,
                                      INVALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_INCOME, VALID_EMAIL, VALID_ADDRESS,
                                      VALID_FAMILY, VALID_TAGS, VALID_HOUSINGTYPE, VALID_REMARK, INVALID_BIRTHDAY);
